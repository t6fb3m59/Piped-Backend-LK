...
public class Streams {
    ...
    /**
     * Available playback modes for this video. Either field of {@code availableModes}
     * may be null when the corresponding mode isn't supported. See {@link AvailableModes}.
     */
    public AvailableModes availableModes;

    /**
     * Backend's recommended playback mode for users on the "Auto" frontend setting.
     * Currently "sabr" when SABR is available, otherwise "legacy".
     */
